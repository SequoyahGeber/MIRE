...
|---|---|---|---:|---|
| S-001 | `DONE` | Adapted supplied mossy boulder and broadleaf tree: removed render/diorama geometry, normalized scale/origin/transforms/names, remapped to MIRE's saturated palette, and flattened the boulder's ground contact. Runtime outputs live in `assets/environment_additions/` | 2 | 1,720 polygons; byte-identical GLBs/catalog across two Blender 5.2 rebuilds, exact catalog, two-preview visual inspection, and fresh Godot 4.7.1 import with 2/2 scenes and zero errors all passed |
...
| A-007 | `DONE` | Basic Ward set: foundation, healthy Ward, damaged Ward, critical Ward, destroyed remains, repair scaffolding, boundary post, activation crystal. Made 8 in `assets/wards/`; 2,182 polygons. Byte-identical GLBs/catalog across two Blender 5.2 rebuilds, GLB 2.0 validation (8/8, exact catalog, no orphans), shared-foundation centre and size drift 0.00 mm across all four condition states, two-preview visual inspection, and fresh Godot 4.7.1 import with 8/8 scenes and zero errors all passed | 8 | A-003 |
| A-008 | `DONE` | Wellspring set: distant monolith, base, crystal, basin, roots, uncapped state, capped state, re-corrupting state, corrupted state, ritual pedestal, boundary stones, guardian platform. Made 12 in `assets/wellsprings/`; 3,631 polygons. Byte-identical GLBs/catalog across two Blender 5.2 rebuilds, GLB 2.0 validation (12/12, exact catalog, no orphans), shared 4.6 m foundation centre and size drift 0.00 mm across all four condition states, two-preview visual inspection, and fresh Godot 4.7.1 import with 12/12 scenes and zero errors all passed | 12 | A-007 |
