...
> **2026-08-18 — P0 is complete, and there is deliberately no `NEXT` row.** A-010 closed the last P0
...
| Batch | Status | Asset set | Planned models | After |
|---|---|---|---:|---|
| A-011 | `BLOCKED` | *(gate: 2.14's playtest feedback, see the note above)*  Gatherable plants: berry bush full/harvested, poison berry bush, fibre plant, medicinal herb, wild onion, honeycomb, clay deposit, peat deposit, resin node | 10 | A-002 |
